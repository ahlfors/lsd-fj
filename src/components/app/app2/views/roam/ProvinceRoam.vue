<!--家庭宽带 -->
<template>
  <viewTemplate class="a2-roam-provinceRoam" :interval="30" @interval="getData">
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.loadData(null, 'w1349', (res1) => { // 省际(福建)漫入用户总数 w1347
          this.roamInNum = +(res1[0].KPI_VALUE / 10000).toFixed(2);
          this.loadData(null, 'w1350', (res2) => { // 省际(福建)漫出用户总数 w1348
