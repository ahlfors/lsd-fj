<!--家庭宽带 -->
<template>
  <viewTemplate class="a2-roam-internationalRoam" :interval="30" @interval="getData">
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.loadData(null, 'w1345', (res1) => { // 国际(福建)漫入用户总数 w1343
          this.roamInNum = +(res1[0].KPI_VALUE).toFixed(2);
          this.loadData(null, 'w1346', (res2) => { // 国际(福建)漫出用户总数 w1344
