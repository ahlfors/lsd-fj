<!--退服基站二级-->
<template>
  <div class="gis-tools-div-out-site">
    ...
    <div class="tools-site-body">
      ...
      <div class="out-site-t2-man">
        <div><span>名字</span><span>张明</span></div>
        <div><span>电话</span><span>12345685522</span></div>
      </div>
      <div class="out-site-t2-cs">处理中</div>
    </div>
  </div>
</template>
