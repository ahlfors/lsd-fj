<template>
  <viewTemplate class="a1-mobile-youtube" :interval="30" @interval="loadData">
    <div>
  ...
  export default {
    ...
    methods: {
      loadData() {
        ...
        this.httpSuc = 0;
        this.headDelay = 0;
        this.$http.indi.get('f0287', {}, (res287) => {
          this.activeUserNum = res287.data.data[0].HTTP_ACCESS_TIMES;
          this.downFlow = res287.data.data[0].DOWNSTREAM_TRAFFIC;
          this.upFlow = res287.data.data[0].UPSTREAM_TRAFFIC;
          this.httpAvgDown = res287.data.data[0].HTTP_AVERAGE_DOWNLOAD_RATE;
          this.httpSuc = res287.data.data[0].HTTP_SUCCESS_RATE;
          this.headDelay = res287.data.data[0].HTTP_FIRST_PACKET_RESPONSE_DELAY;
        })
        // window.setTimeout(() => {
