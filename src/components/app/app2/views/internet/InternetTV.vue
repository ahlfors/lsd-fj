<!--互联网电视 -->
<template>
  <viewTemplate class="a2-internet-internetTV" :interval="30" @interval="loadData">
  ...
  export default {
    ...
    methods: {
      loadData() {
        ...
        this.$http.indi.get(['f0129', 'f0130', 'f0131', 'f0132', 'f0133', 'f0134', 'f0135', 'f0136'], {}, (res35, res36, res37, res38, res39, res40, res41, res42) => {
