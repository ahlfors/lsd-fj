<template>
  <viewTemplate class="a2-internet-homeBroadbrand" :interval="30" @interval="loadData">
  ...
  export default {
    ...
    methods: {
      loadData() {
        ...
        this.$http.indi.get(['f0118', 'f0119', 'f0120', 'f0121', 'f0122', 'f0123', 'f0124', 'f0125', 'f0126', 'f0127', 'f0128'], {}, (res24, res25, res26, res27, res28, res29, res30, res31, res32, res33, res34) => {
