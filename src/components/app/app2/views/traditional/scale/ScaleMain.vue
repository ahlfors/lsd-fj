...
<template>
  <popupTemplate >
    <viewTemplate class="a2-traditional-scale">
      <div class="a2-traditional-scale-div"  @click.stop.self="goOne">
        <div is="businessScaleSub" idFlag="two"></div>
        <div class="scale-measure">
          <viewTemplate viewId="0102" class="scale-flow1" :class="{'scale-flow2': downFlag === '01'}" @ok="upDown('flow')" >LTE流量历史走势</viewTemplate>
          <viewTemplate viewId="0103" class="scale-flow1" :class="{'scale-flow2': downFlag === '02'}" @ok="upDown('traffic')">2G话务量历史走势</viewTemplate>
          <viewTemplate viewId="0104" class="scale-flow1" :class="{'scale-flow2': downFlag === '03'}" @ok="upDown('volte')">VoLTE话务量历史走势</viewTemplate>
          <viewTemplate viewId="0105" class="scale-flow1" :class="{'scale-flow2': downFlag === '04'}" @ok="upDown('cmnet')">CMNET流量</viewTemplate>
        </div>
        <viewTemplate  class="scale-measure-chart" :class="{'chartDisplay': chartShow === '02'}" v-show="!iscmnetshow">
        ...
        <div is = "cmnet" v-show="iscmnetshow"></div>
      </div>
    </viewTemplate>
  </popupTemplate>
</template>
