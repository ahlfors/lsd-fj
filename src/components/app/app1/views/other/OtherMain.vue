    ...
    <div class="right-video">
      <div class="video-1">
        ...
        <div style="width: 100%; height: 100%;">
          <object width='302' height='200' id='SampleMediaPlayback1' name='SampleMediaPlayback' type='application/x-shockwave-flash' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'>
      ...
      <div class="video-2">
        ...
        <div style="width: 100%; height: 100%;">
          <object width='302' height='200' id='SampleMediaPlayback2' name='SampleMediaPlayback' type='application/x-shockwave-flash' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'>
            <param name='movie' value='static/swf/SampleMediaPlayback.swf' />
            <param name='quality' value='high' />
            <param name='bgcolor' value='#000000' />
            <param name='allowfullscreen' value='true' />
      ...
      <div class="video-3">
        ...
        <object width='302' height='200' id='SampleMediaPlayback3' name='SampleMediaPlayback' type='application/x-shockwave-flash' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'>
          <param name='movie' value='static/swf/SampleMediaPlayback.swf' />
          <param name='quality' value='high' />
          <param name='bgcolor' value='#000000' />
          <param name='allowfullscreen' value='true' />
      ...
      <div class="weather">
        ...
        <div>
          <div class="list-item">
            <span class="weather-icon" :class="weatherData['fz']['className']"></span>
            <span>福州</span>
          </div>
          <div class="list-item">
            <span>{{weatherData.fz.info}}</span>
            <span class="temperature">{{weatherData.fz.lTemperature}}~{{weatherData.fz.hTemperature}}°C</span>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      initWeather() {
        this.$http.indi.get(['f0098', 'f0099'], {}, (res1, res2) => {
