<!--传统业务-->
<template>
  <div class="a1-traditional-BusinessScale" :interval="30" @interval="loadData">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadData() { // 2G话务量 | LTE流量 | VoLTE话务量 | CMNET流量
        this.$http.indi.get(['f0017', 'f0018', 'f0019', 'f0154', 'f0155', 'f0156', 'f0157', 'f0158', 'f0159', 'f0270', 'f0271', 'f0272', 'f0297', 'f0321', 'f0322', 'f0323'], {}, (res1, res2, res3, res4, res5, res6, res7, res8, res9, res10, res11, res12, res13, res14, res15, res16) => {
          ...
          try {
            ...
            console.log('f0017,f0154,f0270,f0157 indicator has error')
          } finally {
            this.chart1.clear();
            this.chart1.setOption(this.gsm_option);
          }
          try {
            ...
            console.log('f0018,f0155,f0271,f0158 indicator has error')
          } finally {
            this.chart2.clear();
            this.chart2.setOption(this.lte_option);
          }
          try {
            ...
            console.log('f0019,f0156,f0272,f0159 indicator has error')
          } finally {
            this.chart3.clear();
            this.chart3.setOption(this.volte_option);
          }
          try {
            ...
            console.log('f0297 indicator has error')
          } finally {
            this.chart4.clear();
            this.chart4.setOption(this.cmnet_option);
          }
