<template>
    <viewTemplate class="top-success" :interval ="30" @interval ="loadData">
      <div class="top-title">GSM无线掉话率TOP5</div>
      <div class="top-content">
        <div v-for="item in nowData"
             class="list-item">
          <div class="item-text">
...
<script>
    // import topSuccessData from './topSuccess2G.js'
    export default {
      props: {
        sceneName: String,
        areaId: Number
      ...
      methods: {
        loadData() {
          this.$http.indi.get(this.url, {}, (res) => {
            this.nowData = res.data.data.GSM_WIRELESS_DROP_RATE_TOP5;
          })
        }
      },
      watch: {
