  ...
  export default {
    ...
    data() {
      return {
        ...
        points: [
          {
            site1: 'position:absolute;left:500px;top:210px; z-index:100;',
            site2: 'position:absolute;left:1300px;top:680px; z-index:100;',
            site3: 'position:absolute;left:550px;top:600px; z-index:100;',
            site4: 'left:1290px;top:150px;z-index:100;',
            site5: 'left:380px;top:500px;z-index:100'
          }, // 国际会议展览中心
          {
            site1: 'position:absolute;left:250px;top:210px; z-index:100;',
            site2: 'position:absolute;left:1300px;top:680px; z-index:100;',
            site3: 'position:absolute;left:920px;top:80px; z-index:100;',
            site4: 'left:1290px;top:300px;z-index:100;',
            site5: 'left:700px;top:400px;z-index:100'
          }, // 国际会议中心
          {
            site1: 'position:absolute;left:250px;top:200px; z-index:100;',
            site2: 'position:absolute;left:1700px;top:670px; z-index:100;display:none',
            site3: 'position:absolute;left:550px;top:300px; z-index:100;display:none',
            site4: 'left:200px;top:300px;z-index:100;display:none',
            site5: 'left:700px;top:680px;z-index:100'
          }, // 国际会展酒店
          {
            site1: 'position:absolute;left:250px;top:80px; z-index:100;',
            site2: 'position:absolute;left:1300px;top:680px; z-index:100;display:none',
            site3: 'position:absolute;left:550px;top:700px; z-index:100;display:none',
            site4: 'left:1290px;top:200px;z-index:100;display:none',
            site5: 'left:700px;top:700px;z-index:100'
          }, // 海悦山庄酒店
          {
            site1: 'position:absolute;left:250px;top:210px; z-index:100;',
            site2: 'position:absolute;left:1300px;top:680px; z-index:100;display:none',
            site3: 'position:absolute;left:550px;top:310px; z-index:100;display:none',
            site4: 'left:1290px;top:300px;z-index:100;display:none',
            site5: 'left:700px;top:700px;z-index:100'
          }, // 闽南大戏院
          {
            site1: 'position:absolute;left:250px;top:800px; z-index:100;',
            site2: 'position:absolute;left:1300px;top:680px; z-index:100;display:none',
            site3: 'position:absolute;left:550px;top:310px; z-index:100;display:none',
            site4: 'left:1290px;top:300px;z-index:100;display:none',
            site5: 'left:700px;top:700px;z-index:100'
          ...
          {
            site1: 'position:absolute;left:250px;top:210px; z-index:100;',
            site2: 'position:absolute;left:1300px;top:500px; z-index:100;display:none',
            site3: 'position:absolute;left:550px;top:260px; z-index:100;display:none',
            site4: 'left:1290px;top:320px;z-index:100;display:none',
            site5: 'left:750px;top:280px;z-index:100'
          } // 市政府
        ]
      }
    },
    computed: {
      currentPoint() {
        return this.points[this.currentMapIndex];
      }
    },
    watch: {
      sceneName(val) {
        ...
        switch (val) {
          ...
          case '国际会议中心':
            ...
            this.currentPoint = this.points[1];
            break;
          case '国际会展酒店':
          ...
          case '海悦山庄酒店':
            ...
            this.currentPoint = this.points[3];
            break;
          case '闽南大戏院':
            this.currentMapIndex = 4;
            this.currentPoint = this.points[4];
            break;
          case '厦门高崎国际机场':
            this.currentMapIndex = 5;
            this.currentPoint = this.points[5];
            break;
          case '市政府':
            this.currentMapIndex = 6;
            this.currentPoint = this.points[6];
            break;
        }
    ...
    methods: {
      chooseMap() {
        this.currentMapIndex = this.activeState;
      },
