      ...
      methods: {
        loadBusiness() {
          this.$http.indi.get(this.url, {}, (res) => {
            ...
            this.dataNum4 = res.data.data.HTTP_SUC_RATE;
        ...
        .businessindex-content{
            ...
            .businessindex-item{
                ...
                .businessindex-item-title{
                    ...
                    // padding-left: 68px;
                    // &.item-bg-1{
                    //    background-image: url(../../../../assets/img/venues/stagescene/item-bg-1.png);
                    //    background-repeat: no-repeat;
                    //    background-position: 10px 5px;
                    // }
                    // &.item-bg-2{
                    //    background-image: url(../../../../assets/img/venues/stagescene/item-bg-2.png);
                    //    background-repeat: no-repeat;
                    //    background-position: 10px 2px;
                    // }
                    // &.item-bg-3{
                    //    background-image: url(../../../../assets/img/venues/stagescene/item-bg-3.png);
                    //    background-repeat: no-repeat;
