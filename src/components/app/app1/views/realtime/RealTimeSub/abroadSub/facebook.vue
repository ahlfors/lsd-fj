<template>
  <viewTemplate class="a1-mobile-facebook" :interval="30" @interval="loadData">
    <div>
  ...
  export default {
    ...
    methods: {
      loadData() {
        ...
        this.httpSuc = 0;
        this.headDelay = 0;
        this.$http.indi.get('f0283', {}, (res283) => {
          this.activeUserNum = res283.data.data[0].HTTP_ACCESS_TIMES;
          this.downFlow = res283.data.data[0].DOWNSTREAM_TRAFFIC;
          this.upFlow = res283.data.data[0].UPSTREAM_TRAFFIC;
          this.httpAvgDown = res283.data.data[0].HTTP_AVERAGE_DOWNLOAD_RATE;
          this.httpSuc = res283.data.data[0].HTTP_SUCCESS_RATE;
          this.headDelay = res283.data.data[0].HTTP_FIRST_PACKET_RESPONSE_DELAY;
        })
        // window.setTimeout(() => {
